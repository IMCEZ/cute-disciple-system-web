...
(function () {
  ...
  function requestAccountDeletion() {
    ...
    }).catch(function () { setProfileStatus('无法打开注销确认，请刷新后重试。', true); });
  }
  ...
  function ensureUi() {
    ...
    var cancelAccountButton = document.getElementById('dz-profile-cancel-account');
    var profileActions = document.querySelector('#dz-account-panel .dz-profile-actions');
    if (cancelAccountButton && profileActions) profileActions.appendChild(cancelAccountButton);
